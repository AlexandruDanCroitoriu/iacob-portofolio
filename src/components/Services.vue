      ...
      <div class="flex flex-col lg:flex-row gap-6 items-stretch w-full">
        ...
        >
          ...
          <div class="px-4 py-5 sm:p-6 flex-1">
            ...
            <p class="text-gray-100 text-start leading-relaxed">
      ...
      <Transition name="modal">
        ...
        >
          <div class="bg-gray-900 w-full h-full overflow-hidden flex flex-col">
            <!-- Modal Header -->
            <div class="bg-gray-800 px-6 py-4 border-b border-gray-700 flex justify-between items-center flex-shrink-0">
            ...
            <!-- Modal Footer -->
            <div class="bg-gray-800 px-6 md:px-12 lg:px-24 py-6 border-t border-gray-700 flex flex-col sm:flex-row gap-3 justify-end flex-shrink-0">
              <button
                @click="closeModal"
                class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-all duration-300 font-semibold"
              >
